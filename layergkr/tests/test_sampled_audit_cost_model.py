...
def test_headline_cost_row():
    ...
    assert bridge["manifest_claims_materialized"] == 1503
    assert bridge["manifest_fraction_materialized"] == 1503 / 2596
    assert bridge["family_coverage"]["product-tree"]["materialized"] == 74
